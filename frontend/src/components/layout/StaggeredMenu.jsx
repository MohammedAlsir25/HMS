...
const navItems = [
  ...
  { label: 'Preoperative', link: '/preoperative' },
  { label: 'Wards', link: '/wards' },
  { label: 'In-Patient', link: '/inpatient' },
  { label: 'Surgery Gantt', link: '/surgery' },
  { label: 'Surgery Dashboard', link: '/surgery/dashboard' },
  { label: 'Surgery Scheduler', link: '/surgery/schedule' },
  ...
  { label: 'Optic Lab', link: '/optic-lab' },
