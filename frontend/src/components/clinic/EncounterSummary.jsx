...
export default function EncounterSummary({ patient, vitals, symptoms, diagnosis, diagnosisIcd10, medications, soapNotes, onClose }) {
  const handlePrint = () => {
    ...
    printWin.document.write(`
      ...
      <body>
        ...
        <div class="footer">Generated by AL Jawahir Hospital HMS on ${new Date().toLocaleString()}</div>
